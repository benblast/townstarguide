...
import { steps } from './Beginner/Improving'
...
export default {
  ...
  data: () => ({
    ...
    card: {
      title: 'Efficiency & Expansion',
      intro: "You finished the Beginner's Guide, now what?",
      img: require('../../assets/ingame/buildings/icon_craneBot.png'),
      imgSize: '100%',
      text: "        <p style=\"font-weight: bold;\">" +
          "          - How do you expand safely?<br>" +
          "          - How do you approach making things more efficient?<br>" +
          "          - How to get Gasoline production to satisfactory levels?" +
          "        </p>" +
